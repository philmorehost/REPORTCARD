...
<body>
    ...
    <div class="sidebar d-none d-lg-flex flex-column p-3">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li><a href="/views/super_admin/banner_management.php" class="nav-link <?php echo $current_page == 'banner_management.php' ? 'active' : ''; ?>"><i class="bi bi-images me-2"></i>Banner Ads</a></li>
        </ul>
        <hr>
